...
export default function EducationSectionClient({
  education,
}: EducationSectionClientProps) {
    ...
    >
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {education.map((edu) => {
            const certificateUrl = edu.certificateImage
              ? urlFor(edu.certificateImage).width(1600).url()
              : null;
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 p-6">
                  ...
                  {/* Website link + Certificate Dialog */}
